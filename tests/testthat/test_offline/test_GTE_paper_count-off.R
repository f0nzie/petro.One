...
test_that("all queries match expected values", {
    ...
    expected <- c(71, 3181, 4795, 885, 8023, 13822, 13822, 560, 1781, 4, 9, 0, 4, 0)
    ...
    m <- mock(71, 3181, 4795, 885, 8023, 13822, 13822, 560, 1781, 4, 9, 0, 4, 0)
    with_mock(get_papers_count = m, {
        ...
        for (t in all_tests) {
            ...
            expect_equal(cur_count, t$x)   # expect_gte(cur_count, t$x)
            ix <- ix + 1
        }
    })
})
