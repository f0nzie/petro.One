...
```{r}
url <- "https://www.onepetro.org/search?q=\"machine+learning\"AND\"economics\"AND\"GPR\"&peer_reviewed=&published_between=&from_year=&to_year="
...
```{r}
papers.df <- read_multipage(url, doctype = "conference-paper")
```
