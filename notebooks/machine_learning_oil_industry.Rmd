...
```{r}
url <- 'https://www.onepetro.org/search?q="machine+learning"AND"reservoir"AND"data"&peer_reviewed=&published_between=&from_year=&to_year='
...
```{r}
url <- 'https://www.onepetro.org/search?q="machine+learning"AND"logging"AND"data"&peer_reviewed=&published_between=&from_year=&to_year='
